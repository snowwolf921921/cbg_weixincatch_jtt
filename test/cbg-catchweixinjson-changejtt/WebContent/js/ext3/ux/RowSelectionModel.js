...
Ext.ux.grid.RowSelectionModel = function(config){
    ...
    Ext.ux.grid.RowSelectionModel.superclass.constructor.call(this);
};

Ext.extend(Ext.ux.grid.RowSelectionModel, Ext.grid.AbstractSelectionModel,  {
    /**
    ...
    handleMouseDown : function(g, rowIndex, e){
        ...
        if(this.fireEvent("rowclick", this, rowIndex, r) !== false){
...
Ext.ux.grid.CheckboxSelectionModel = Ext.extend(Ext.ux.grid.RowSelectionModel, {
    /**
    ...
    // private
    initEvents : function(){
        Ext.ux.grid.CheckboxSelectionModel.superclass.initEvents.call(this);
